	...
	<div class="card card-outline ">
  	...
  	<div class="card-footer border-top border-info">
  		<div class="d-flex w-100 justify-content-center align-items-center">
  			<button style="background-color: orangered; color:aliceblue;" class="btn btn-flat   mx-2" form="manage-branch">Save</button>
  			<a class="btn btn-flat bg-gradient-secondary mx-2" href="./main.php?page=branch_list">Cancel</a>
  		</div>
  	</div>
	</div>
</div>
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1){
					...
					setTimeout(function(){
              location.href = 'main.php?page=branch_list'
					},2000)
				}
			}
		})
