...
<div id="ptr_clone" class="d-none">
  <table>
    <tr>
        ...
        <td><input type="text" class="text-right number" name='price[]' readonly></td>
...
$(document).ready(function() {
    ...
    $('input[name="weight[]"]').on('input', function() {
        ...
        $('input[name="weight[]"]').each(function() {
            if ($(this).val()) {
                totalPrice += parseFloat($(this).val()*5.5);
            }
        });
    ...
    if($('#parcel-items tbody tr').length <= 0){
      ...
      //       }
        ...
        if(resp == 1){
            alert_toast('Data successfully saved',"success");
            setTimeout(function(){
              // location.href = 'main.php?page=parcel_list';
              location.href ="main.php?page=payment"; 
            },2000)
